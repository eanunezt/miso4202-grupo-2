...
del /Q %WILDFLY%\standalone\deployments\producto-compras.war
copy /Y %WORKSPACE%\marketplace-producto-basico\target\producto-basico.war %WILDFLY%\standalone\deployments\producto-basico.war
