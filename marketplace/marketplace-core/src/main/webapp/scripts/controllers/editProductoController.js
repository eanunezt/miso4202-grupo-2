...
angular.module('marketplace-app').controller('EditProductoController', function($scope, $routeParams, $location, flash, ProductoResource , UsuarioResource, CategoriaResource) {
    var self = this;
